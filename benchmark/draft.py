...
mesh_simplifier.simplify_mesh(target_count = 220, aggressiveness=3, preserve_border=True, verbose=10, max_iterations=3000)
decimated_points, decimated_triangles, _ = mesh_simplifier.getMesh()
decimated_mesh = pyvista.PolyData(decimated_points, faces=triangles_to_faces(decimated_triangles))
decimated_mesh.plot()